...
2 <module 'nipype.interfaces.image' from '/app/.pixi/envs/fmriprep/lib/python3.12/site-packages/nipype/interfaces/image.py'> images (after INU-correction) using
...
Co-registration was configured with six degrees of freedom.
 The aligned T2w image was used for initial co-registration.BOLD runs were slice-time corrected to 0.964s (0.5 of slice acquisition range
