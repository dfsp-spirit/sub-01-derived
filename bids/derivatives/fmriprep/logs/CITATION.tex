...
RRID:SCR\_002823,][]{fsl_fast}. An anatomical T2w-reference map was
computed after registration of 2 \textless module
`nipype.interfaces.image' from
`/app/.pixi/envs/fmriprep/lib/python3.12/site-packages/nipype/interfaces/image.py'\textgreater{}
...
co-registration.BOLD runs were slice-time corrected to 0.964s (0.5 of
slice acquisition range 0s-1.93s) using \texttt{3dTshift} from AFNI
\citep[RRID:SCR\_005927]{afni}. Several confounding time-series were
